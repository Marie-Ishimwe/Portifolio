  ...
  return (
    <section className="min-h-screen bg-color-lighter_Atlantis p-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h2 className="text-4xl font-bold text-center text-color-Emperor mb-8">
            EXPERIENCE
          </h2>
          <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
            {experiences.map((exp, index) => (
              <li key={index}>
                ...
                <div
                  className={`mb-10  text-color-Emperor ${index % 2 === 0 ? "timeline-start md:text-end" : "timeline-end"}`}
                >
